...
public class diag_b {
    ...
    public void main(parameter param, int ik) {
        ...
        HashMap<Integer, HashMap<Integer, double[]>> atomicwfc_d2 = param.atomicwfc_1.get(ik);
        double atomicwfc_[][][] = new double[atomicwfc.size() * 2][atomicwfc.get(0).size()][2];
        ...
        for (int i = 0; i < atomicwfc.size(); i++) {
            for (int j = 0; j < atomicwfc.get(0).size(); j++) {
                ...
                double tem2[] = {atomicwfc_d2.get(i).get(j)[0], atomicwfc_d2.get(i).get(j)[1]};
                atomicwfc_[i + param.iband][j] = tem1;
                atomicwfc_[i][j] = tem2;
        ...
        for (int i = 0; i < atomicwfc.size(); i++) {
            h_psi[i] = param.h_psi_1.get(ik)[i];
            h_psi[param.iband + i] = param.h_psi_2.get(ik)[i];
        ...
        if (param.notcnv == 0) {
            ...
            if (param.nbase + cond > param.iband * 2) {
                ...
                double h_psi_[][][] = new double[atomicwfc.size()][][];
                double h_psi__[][][] = new double[atomicwfc.size()][][];
