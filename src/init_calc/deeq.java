...
public class deeq {
    ...
    public void main(param_upf param, parameter p_g) {
        ...
        double[][][][] deeq = new double[p_g.nat][indv.size()][indv.size()][2];
        for (int i = 0; i < p_g.nat; i++) {
            
        for (int ih = 0; ih < indv.size(); ih++) {
            for (int jh = 0; jh < indv.size(); jh++) {
                deeq[i][ih][jh][0] = dvan[ih][jh][0];
                deeq[i][jh][ih][0] = deeq[i][ih][jh][0];
                deeq[i][ih][jh][1] = dvan[ih][jh][1];
                deeq[i][jh][ih][1] = deeq[i][ih][jh][1];
            }
        }
        }
